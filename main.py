...
wakeup = st.time_input("기상 시간을 입력하세요", value=time(7,30))
...
upload_file = st.file_uploader("파일을 업로드하세요", type=["csv", "xlsx"])
if upload_file:
...
with st.expander("추가 정보 보기", expanded=False):
    ...
    st.text_input("나머지주소", placeholder = "호수")
